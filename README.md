...
The RAT MCU is a basic computer that written in VHDL and run on the Basys 3 development board.

![alt text](https://github.com/joey-bednar/RAT-MCU/blob/[branch]/image.jpg?raw=true)
